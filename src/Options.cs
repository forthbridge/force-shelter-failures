...
namespace ForceShelterFailures
{
    ...
    public class Options : OptionInterface
    {
        ...
        public static Configurable<int> shelterFailureChance = instance.config.Bind("shelterFailureChance", 100, new ConfigurableInfo(
            "Chance of a shelter failure occuring in any given cycle.",
            new ConfigAcceptableRange<int>(0, 100), "", "Shelter Failure Chance"));
        ...
        public override void Initialize()
        {
            ...
            AddSlider(shelterFailureChance, (string)shelterFailureChance.info.Tags[0], "0%", "100%");
